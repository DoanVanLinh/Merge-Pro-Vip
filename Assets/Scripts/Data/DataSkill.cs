...
//    {
//        public Dictionary<EActiveSkill, Dictionary<EPassiveSkill, bool>> InteractionMatrix;
...
//                    ActiveSkillConfig config = new ActiveSkillConfig();
//                    int.TryParse(_data[3], out config.BaseBulletNumb);
//                    config.BaseCooldown = Helper.ParseFloat(_data[4]);
//                    config.BaseDamage = Helper.ParseFloat(_data[5]);
//                    config.BaseBulletSpeed = Helper.ParseFloat(_data[6]);
//                    config.BaseAreaScale = Helper.ParseFloat(_data[7]);
//                    config.BaseDuration = Helper.ParseFloat(_data[8]);
//                    config.BaseHitPerSec = Helper.ParseFloat(_data[9]);
//                    int.TryParse(_data[10], out config.BaseHitEffect);
//                    config.PushBackForce = Helper.ParseFloat(_data[11]);
//                    int.TryParse(_data[12], out config.MaxLevel);
//                    int.TryParse(_data[13], out config.Priority);
